...
public class RTPClient {
    ...
    public RTPClient(MediaLocator locator,String ipAddress,
                     String port) {
    ...
    private String createProcessor() {
        ...
        for (int i = 0; i < tracks.length; i++) {
            ...
            if (  tracks[i].isEnabled() &&  format instanceof AudioFormat) {
                ...
                AudioFormat ulawFormat =   new AudioFormat(AudioFormat.DVI_RTP,// afmt.getSampleRate(),
                        //  afmt.getSampleSizeInBits(), afmt.getChannels());
                        8000,4,1);
    ...
    private String createTransmitter() {
        ...
        try {
            ...
            dataOutput.start();
            System.out.println("sent to : " + rtpURL);
